...
import jFuzzyLogic.defuzzifier.DefuzzifierCenterOfGravityFunctions;
import jFuzzyLogic.defuzzifier.DefuzzifierCenterOfGravitySingletons;
import jFuzzyLogic.defuzzifier.DefuzzifierContinuous;
...
import jFuzzyLogic.membership.MembershipFunctionCosine;
import jFuzzyLogic.membership.MembershipFunctionDifferenceSigmoidal;
import jFuzzyLogic.membership.MembershipFunctionFuncion;
import jFuzzyLogic.membership.MembershipFunctionGaussian;
import jFuzzyLogic.membership.MembershipFunctionGaussian2;
import jFuzzyLogic.membership.MembershipFunctionGenBell;
import jFuzzyLogic.membership.MembershipFunctionGenericSingleton;
import jFuzzyLogic.membership.MembershipFunctionPieceWiseLinear;
import jFuzzyLogic.membership.MembershipFunctionSigmoidal;
import jFuzzyLogic.membership.MembershipFunctionSingleton;
import jFuzzyLogic.membership.MembershipFunctionTrapetzoidal;
import jFuzzyLogic.membership.MembershipFunctionTriangular;
