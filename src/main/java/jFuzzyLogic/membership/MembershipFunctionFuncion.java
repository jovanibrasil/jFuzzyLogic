package jFuzzyLogic.membership;
...
import jFuzzyLogic.membership.functions.MffAbs;
import jFuzzyLogic.membership.functions.MffCos;
import jFuzzyLogic.membership.functions.MffDivide;
import jFuzzyLogic.membership.functions.MffExp;
import jFuzzyLogic.membership.functions.MffFunction;
import jFuzzyLogic.membership.functions.MffLn;
import jFuzzyLogic.membership.functions.MffLog;
import jFuzzyLogic.membership.functions.MffModulus;
import jFuzzyLogic.membership.functions.MffNop;
import jFuzzyLogic.membership.functions.MffPow;
import jFuzzyLogic.membership.functions.MffSin;
import jFuzzyLogic.membership.functions.MffSubstract;
import jFuzzyLogic.membership.functions.MffSum;
import jFuzzyLogic.membership.functions.MffTan;
import jFuzzyLogic.membership.functions.MffTimes;
...
public class MembershipFunctionFuncion extends MembershipFunctionDiscrete {
	...
	/**
	 * @see jFuzzyLogic.membership.MembershipFunctionDiscrete#iterator()
	 */
	@Override
	...
	/**
	 * @see jFuzzyLogic.membership.MembershipFunction#membership(double)
	 */
	@Override
	...
	/**
	 * @see jFuzzyLogic.membership.MembershipFunctionDiscrete#membership(int)
	 */
	@Override
