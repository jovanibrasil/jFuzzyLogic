...
public abstract class JFuzzyChart {
	...
	public static JFuzzyChart get() {
		...
		try {
			...
			if (UseMockClass) jFuzzyChart = (JFuzzyChart) Class.forName("jFuzzyLogic.plot.JFuzzyChartMock").newInstance();
			else jFuzzyChart = (JFuzzyChart) Class.forName("jFuzzyLogic.plot.JFuzzyChartImpl").newInstance();
